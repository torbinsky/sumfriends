...
public class Global extends GlobalSettings {
	...
	public void onStart(Application app) {
		...
		try{
			...
			DataService.saveMatchStats(new MonitoredSummonerStats(1743039968, 31243475, true, 1710, Tier.GOLD.name(), "II", new Date(1424954223000L)));
			DataService.saveMatchStats(new MonitoredSummonerStats(1743889555, 31243475, true, 1735, Tier.GOLD.name(), "II", new Date(1425030292000L)));
			DataService.saveMatchStats(new MonitoredSummonerStats(1743971569, 31243475, true, 1761, Tier.GOLD.name(), "II", new Date(1425034535000L)));
			DataService.saveMatchStats(new MonitoredSummonerStats(1744035371, 31243475, true, 1787, Tier.GOLD.name(), "II", new Date(1425038738000L)));
			DataService.saveMatchStats(new MonitoredSummonerStats(1744116636, 31243475, false, 1773, Tier.GOLD.name(), "II", new Date(1425044604000L)));
			DataService.saveMatchStats(new MonitoredSummonerStats(1744150643, 31243475, false, 1765, Tier.GOLD.name(), "II", new Date(1425046957000L)));
		}catch(Exception e){
